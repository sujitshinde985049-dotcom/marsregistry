    ...
    <main>
      <section className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero-content shell">
          ...
          <div className="hero-actions"><Link className="button button-primary" href="#regions">EXPLORE MARS <Arrow /></Link><Link className="button button-ghost" href="#packages">GIFT A PLACE ON MARS</Link></div>
        </div>
